// Dispatches the hand-authored flash_attention_fwd MSL kernel as an external
// metal-msl-fb object. Flattened tensors: n_heads*seq_len*d_head f32.
...
module @flash attributes {hal.device.targets = [#metal_device]} {
  ...
  // n=2 heads, s=16 seq, d=8 -> 256 elems; workload = n*s = 32.
  func.func @flash(%Q: tensor<256xf32>, %K: tensor<256xf32>, %V: tensor<256xf32>) -> tensor<256xf32> {
    ...
    %0 = flow.dispatch @flash_attention::@flash_attention_fwd[%workload](%n, %s, %d, %Q, %K, %V)
